...
del applylist[20]
del applylist[0]   
logWagecluster=dfapplylog(Full_Wage_Cluster,applylist)
...
#use this to get nice plots of distributions in your sample
sns.distplot(Pre_pd_task_mean['Whole Sample'])
