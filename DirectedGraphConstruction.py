# -*- coding: utf-8 -*-
"""
Created on Tue Jan 22 11:40:05 2019
This code builds the entire sequence of directed graphs, for both ACS codes and SOC codes, and for Unwighted, Task Weighted, and Skill
Weighted Bipartites
@author: Daniel Sharp
"""
...
#load up the Biadjacency Matrices 
#ACS Biadjacancy
ACS_T_Bipartite=pd.read_excel('ACS IWA Task Intensity Weighted Bipartite.xlsx')
ACS_S_Bipartite=pd.read_excel('ACS skill weighted IWA Bipartite.xlsx')
ACS_Unw_Bipartite=pd.read_excel('ACS Unweighted Bipartite.xlsx')

SOC_S_Bipartite=pd.read_excel('Job Task Bipartite Adjacency - Weighted by Skill Level.xlsx')
SOC_Unw_Bipartite=pd.read_excel('SOC Unweighted Bipartite.xlsx')
SOC_T_Bipartite=pd.read_excel('SOC Task Weighted Bipartite.xlsx')

#build and save the graphs
#ACS Codes
ACS_Directed_Skill_Graph=Mealy_Projection(ACS_S_Bipartite,Directed=True)
ACS_Directed_Skill_Graph.to_excel('ACS Directed Skill Graph.xlsx')

ACS_Directed_Task_Graph=Mealy_Projection(ACS_T_Bipartite,Directed=True)
ACS_Directed_Task_Graph.to_excel('ACS Directed Task Graph.xlsx')

ACS_Directed_Un_Graph=Mealy_Projection(ACS_Unw_Bipartite, Directed=True)
ACS_Directed_Un_Graph.to_excel('ACS Directed Unweighted Graph.xlsx')

#SOC codes
SOC_Directed_Skill_Graph=Mealy_Projection(SOC_S_Bipartite,Directed=True)
SOC_Directed_Skill_Graph.to_excel('SOC Directed Skill Graph.xlsx')

SOC_Directed_Task_Graph=Mealy_Projection(SOC_T_Bipartite,Directed=True)
SOC_Directed_Task_Graph.to_excel('SOC Directed Task Graph.xlsx')

SOC_Directed_Un_Graph=Mealy_Projection(SOC_Unw_Bipartite, Directed=True)
SOC_Directed_Un_Graph.to_excel('SOC Directed Unweighted Graph.xlsx')
